...
juce::Colour Constants::lcdOn = juce::Colour::fromRGB(0, 0, 127);
juce::Colour Constants::lcdOnLight = Constants::lcdOn.brighter();
juce::Colour Constants::lcdOff = juce::Colour::fromRGB(0, 127, 200);
